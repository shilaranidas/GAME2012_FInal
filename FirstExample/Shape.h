...
//		float theta = 0.0f;
//		float crystal_R = 1.0;
//		float crystal_Y = 2.0;// Y-coordinate of center of circle.
//		theta = 0.0f;
//		shape_vertices.push_back(0.0);
//		shape_vertices.push_back(crystal_Y + 2);
//		shape_vertices.push_back(0.0);			
//		for (int i = 1; i < sides + 1; ++i)
//		{
//			shape_vertices.push_back(crystal_R * cos(theta));
//			shape_vertices.push_back(crystal_Y);
//			shape_vertices.push_back(crystal_R * sin(theta));
//			shape_colors.push_back(0.0);
//			shape_colors.push_back(1.0);
//			shape_colors.push_back(0.0);
//			theta += 2 * PI / sides;
//
//		}		
...
struct Prism : public Shape
{
	Prism(int sides)
	{
		...
		//}
			...
			for (int i = 0; i < sides; ++i)
			{
				shape_uvs.push_back(1.0f); shape_uvs.push_back(0.0f);
				shape_uvs.push_back(0.0f); shape_uvs.push_back(1.0f);
				shape_uvs.push_back(1.0f); shape_uvs.push_back(1.0f);
				shape_uvs.push_back(0.0f); shape_uvs.push_back(0.0f);
			}
		ColorShape(1.0f, 1.0f, 1.0f);
		CalcAverageNormals(shape_indices, shape_indices.size(), shape_vertices, shape_vertices.size());
	}
